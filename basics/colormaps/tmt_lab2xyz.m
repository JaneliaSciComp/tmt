function rXYZ = tmt_lab2xyz(rLab)

    % This function is now proved by the Matlab Image Processing Toolbox, so we just
    % use that.  Kept this around in case we ever find ourselves without that
    % toolbox.
